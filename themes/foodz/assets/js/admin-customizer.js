						...
						if (control) {
							...
							for (var j in depend[i]) {
								if (
									...
									|| (depend[i][j] == 'not_empty' && (val !== '' && val !== '0' && val !== 0))      // Main field value is not empty - show current field
									|| (depend[i][j] == 'is_empty' && (val === '' || val === '0' || val === 0))    // Main field value is empty - show current field
