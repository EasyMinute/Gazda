				...
				<form class="woocommerce-cart-form" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
					...
					<table
						...
						<tr>
							...
							<th class="c-cart__shop-th c-cart__shop-th--product-price c-cart__shop-th--item-price"><?php esc_html_e( 'Price', 'woocommerce' ); ?></th>
								...
								<tr class="c-cart__shop-tr <?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
									...
									<td class="c-cart__shop-td c-cart__shop-td--product-thumbnail">
										...
										echo apply_filters( 'woocommerce_cart_item_remove_link', sprintf(
											'<a href="%s" class="c-cart__shop-remove remove" aria-label="%s"  data-product_id="%s" data-product_sku="%s">' . ideapark_svg( 'close', 'c-cart__shop-remove-svg' ) . '</a>',
									...
									<td class="c-cart__shop-td c-cart__shop-td--product-name"
										...
										if ( $_product->get_type() == 'variation' ) {
											...
											$name                 = esc_html( $_product->get_title() ) . ( $variation_attributes ? ideapark_wrap( implode( ', ', $variation_attributes ), '<span class="c-cart__shop-variation">', '</span>' ) : '' );
										} else {
						...
						<span class="c-cart__shop-update">
							...
							<?php echo ideapark_svg( 'update', 'c-cart__shop-update-svg' ); ?>
						</span>
