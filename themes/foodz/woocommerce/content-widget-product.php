		...
		<div class="c-product-list-widget__wrap">
			<div class="c-product-list-widget__thumb-col">
				<a href="<?php echo esc_url( $product->get_permalink() ); ?>">
					<?php ideapark_wp_scrset_on( 'retina' ); ?>
			...
			<div class="c-product-list-widget__title-col">
				...
				<div class="c-product-list-widget__title">
					<a class="c-product-list-widget__title-link" href="<?php echo esc_url( $product->get_permalink() ); ?>"><?php echo wp_kses_post( $product->get_name() ); ?></a>
				</div>
